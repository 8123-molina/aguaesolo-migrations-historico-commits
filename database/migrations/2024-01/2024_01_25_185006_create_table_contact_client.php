...
CREATE TABLE IF NOT EXISTS `contact_client` (
  ...
  CONSTRAINT `fk_contact_client_client` FOREIGN KEY (`client_id`) REFERENCES `client` (`id`),
  CONSTRAINT `fk_contact_client_contact` FOREIGN KEY (`contact_id`) REFERENCES `contact` (`id`)
