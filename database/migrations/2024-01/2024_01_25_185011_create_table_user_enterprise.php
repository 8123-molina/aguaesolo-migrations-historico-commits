...
CREATE TABLE IF NOT EXISTS `user_enterprises` (
  ...
  CONSTRAINT `FK_user_enterprise_empresa` FOREIGN KEY (`enterprise_id`) REFERENCES `enterprises` (`id`),
  CONSTRAINT `FK_user_enterprise_usuario` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
